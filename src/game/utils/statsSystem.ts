...
import { applyPassiveStatModifiers, PassiveId } from '@data/itemPassives';
import { MAX_TENACITY } from '@battle/logic/crowdControlSystem';
import { rollCriticalStrikeRng } from '@battle/logic/critSystem';
