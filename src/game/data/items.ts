import { PassiveId, getPassiveById } from '@data/itemPassives';
...
export const ITEM_DATABASE: Record<string, Item> = {
  ...
  bamis_cinder: {
    ...
    rarity: 'epic',
    price: 900,
    imagePath: '/assets/global/images/items/Bami\'s_Cinder_item.png',
    classes: ['vanguard', 'warden', 'juggernaut'],
  ...
  executioners_calling: {
    ...
    rarity: 'epic',
    price: 900,
    imagePath: '/assets/global/images/items/Executioner\'s_Calling_item.png',
    classes: ['skirmisher', 'assassin', 'marksman', 'juggernaut'],
  ...
  heartbound_axe: {
    ...
    classes: ['skirmisher', 'assassin', 'marksman', 'juggernaut'],
    stats: { attackDamage: 20, speed: 0.2 },
  },
  hexdrinker: {
    id: 'hexdrinker',
    name: 'Hexdrinker',
  ...
  seekers_armguard: {
    ...
    rarity: 'epic',
    price: 800,
    imagePath: '/assets/global/images/items/Seeker\'s_Armguard_item.png',
  ...
  spectre_cowl: {
    ...
    rarity: 'epic',
    price: 1250,
    imagePath: '/assets/global/images/items/Spectre\'s_Cowl_item.png',
    classes: ['skirmisher', 'assassin', 'marksman', 'juggernaut'],
  ...
  wardens_mail: {
    ...
    rarity: 'epic',
    price: 1000,
    imagePath: '/assets/global/images/items/Warden\'s_Mail_item.png',
    classes: ['vanguard', 'warden', 'juggernaut'],
    stats: { armor: 40 },
