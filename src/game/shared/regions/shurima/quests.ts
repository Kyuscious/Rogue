import { SHURIMA_MINIONS, SHURIMA_ELITES, SHURIMA_BOSSES, SHURIMA_CHAMPIONS } from './enemies';
  ...
  },
  {
    ...
    paths: [
      ...
      },
      {
        ...
        difficulty: 'risky' as const,
        // 10 encounters. Each entry is one encounter by default.
        enemyIds: [
          'random:minion:construct',
          'random:minion:construct',
          'random:minion:construct',
          'random:minion:construct',
          'random:elite:construct',
          ...
          'random:minion:construct',
          'random:minion:construct',
          SHURIMA_CHAMPIONS[1].id, // Encounter 10: Azir champion
        ],
        lootType: 'mixed' as const,
        rewardGoldMultiplier: 1.2,
        rewardExpMultiplier: 1.2,
        finalBossId: SHURIMA_CHAMPIONS[1].id,
      },
    ],
  },
  {
    ...
    paths: [
      ...
      },
      {
        ...
        enemyIds: [
          ...
          'random:elite:construct',
          'random:minion:mortal', 'random:minion:beast', 'random:minion:construct', 'random:minion:mortal',
          SHURIMA_CHAMPIONS[0].id,
        ],
        lootType: 'mixed' as const,
        rewardGoldMultiplier: 1.5,
        rewardExpMultiplier: 1.2,
        finalBossId: SHURIMA_CHAMPIONS[0].id,
      },
    ],
  },
];
