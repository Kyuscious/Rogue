/**
 * Runeterra Events
 * Universal events accessible from all regions with lower default weight
 * These represent the fundamental forces and mysteries of Runeterra itself
 */
...
export const RUNETERRA_EVENTS: GameEvent[] = [
  {
    ...
    weight: 0.5, // Lower weight - rare across all regions
    data: {
      treasureType: 'cache',
  ...
  {
    id: 'runeterra_spirit_bond',
    title: 'Spirit Bond',
    description: 'A wandering sprite lingers nearby, looking for a summoner to trust.',
    type: 'dialogue',
    icon: '🐾',
    rarity: 'rare',
    originRegions: ['runeterra'],
    ...
    data: {
      npcName: 'Lost Sprite',
      dialogue: 'The tiny spirit circles you once, then waits to see if you will accept its help.',
      familiarId: 'rune_sprite',
      options: [
        {
          id: 'accept_sprite',
          text: 'Welcome the sprite',
          outcome: 'familiar',
          value: 'rune_sprite',
          successRate: 100,
        },
  ...
  },
  {
    ...
    rarity: 'epic',
    originRegions: ['runeterra'],
    weight: 0.2, // Very rare - legendary encounter
    data: {
