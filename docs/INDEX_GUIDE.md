...
| Weapons | Show all weapon entries | Reveal only after the player has successfully used that weapon in battle on that profile; supports search and grouping by rarity or region of origin |
| Spells | Show all spell entries | Reveal only after the player has successfully cast that spell in battle on that profile; supports search and grouping by rarity or region of origin |
